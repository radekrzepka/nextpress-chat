...
import type { ResetPasswordEmailForm as ResetPasswordEmailFormType } from "./reset-password-email-form-schema";
import { resetPasswordEmailFormSchema } from "./reset-password-email-form-schema";
...
export const ResetPasswordEmailForm = () => {
   const {
      ...
      handleSubmit,
      formState: { errors },
   } = useForm<ResetPasswordEmailFormType>({
   ...
   const { mutate: signUpMutation, isPending } = useMutation<
      string,
      ApiError,
      ResetPasswordEmailFormType
   >({
      mutationFn: async ({ email }: ResetPasswordEmailFormType) => {
   ...
   const onSubmit: SubmitHandler<ResetPasswordEmailFormType> = data => {
      signUpMutation(data);
   };
